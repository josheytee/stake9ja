<template>
  <div class="panel panel-info responsible">
    ...
    <p>
      ...
      off period, in accordance with the bonus terms and condions. We cannot reinstate any expired bonuses if the
      account
    ...
    <p>
      ...
      Customer Support team. Please note that an account closed under our standard account closure can be reopened at
      any
      me by contacng our Customer Support team. If you feel you are at risk of developing a gaming problem or believe
      you
    ...
    <p>
      ...
      circumstances unl the expiry of the self-excluded period. Once the period has expired, your account will
      automacally
      be reacvated.
    </p>
    <p>
    ...
    <p>
      ...
      re-opening your account or opening new accounts. However, during the period of your exclusion, you must not aempt
      to
    ...
    <p>
      ...
      material. However, we cannot be held liable for any third-party affiliate markeng that you may receive that we
      have
    ...
    <p>
      ...
      Whilst most people do gamble responsibly, for some, gaming can become a problem. Please read the informaon below.
      It
    ...
    <ul>
      ...
      <li>
        Gaming is not advised if you are in recovery for any dependency or are under the influence of alcohol or any
        other
        substance.
      </li>
      <li>
    ...
    <h2> 9.2. Play responsibly: recognise a problem </h2>
    <p>Answering the self-assessment below will help you consider whether you have a problem: </p>
    <ul>
      <li>1. Do you gamble to escape from a boring or unhappy life?</li>
      <li> 2. When gaming and you run out of money, do you feel lost and in despair and need to gamble again as soon as
        possible?
      </li>
      <li>3. Do you gamble unl your last penny is gone, even the fare home or the cost of a cup of tea?</li>
      <li>4. Have you ever lied to cover up the amount of money or me you have spent gaming?</li>
      <li> 5. Have you lost interest in your family, friends or hobbies because of your gaming?</li>
      <li>6. Aer losing, do you feel you must try and win back your losses as soon as possible?</li>
      <li> 7. Do arguments, frustraons or disappointments make you want to gamble?</li>
      <li> 8. Do you feel depressed or even suicidal because of your gaming?</li>
    </ul>
    <p>
    ...
    <h2> 9.3. Play responsibly: geng further help</h2>
    <p>
    ...
    <ul>
      <li>• Gamblers Anonymous Internaonal Service Office - This organisaon provides details of your nearest local
        parcipang
        Gamblers Anonymous support group. Please visit www.gamblersanonymous.org for further details.
      </li>
      <li>• Gamcare – This organisaon provides responsible gaming informaon, and provides links and signposng to other
        Internaonal support agencies for problem gaming and related issues
      </li>
      <li>• GamBlock - If you wish to refrain from gaming we strongly advise you to install gaming website blocking
        soware
        such as GamBlock. Please visit www.gamblock.com
      </li>
    </ul>
    <p>For any other quesons regarding responsible gaming please contact Customer Support.</p>
    <h2>9.4. Play responsibly: Prevenng underage gaming</h2>
    <p> We only accept customers over 18 years of age. To diminish the chance of underage gaming, we ask for idenficaon
      and
      documentaon if we suspect a customer is under 18. Although we dedicate a lot of me and resources to ensure there
      are
      no minors playing, we feel this prevenon works best as a shared responsibility between us and the minor’s
      parents/guardians.</p>
    <p>We ask that if young people have access to a computer or a tablet with Internet access, that you take care to
      keep
      your account number and password confidenal, and that you do not leave children unaended around your device while
      you are using our facilies.</p>
    <p>You could also use a number of parental filtering soluons that can be used to monitor or restrict access to the
      Internet:</p>
    <ul>
      <li>• www.netnanny.com - filtering soware that protects children from inappropriate web content.</li>
      <li>• www.cybersier.com - a filtering soware which allows parents to add their own sites to block.</li>
      <li>• www.beerinterneorkids.eu - a website which is co-funded by the EU and provides informaon about internet
        filter
        soware and also offers a free test version.
      </li>
    </ul>
    <p>If you are worried that someone underage is using our Website, please do not hesitate to contact us and we will
      take the necessary steps.</p>

    <p>In accordance with our Terms of Use, if anyone is found to be under the age of 18 years old, all bets placed will
      become null and void and any winnings forfeited. Other legal ramificaons may also apply.</p>
    <p> Please note that if you breach our Responsible Gaming Policy, we may suspend or close your account. </p>
